...
public class InfoHud {
    ...
    // Contador de FPS propio (no necesita accesswidener)
    ...
    private static void renderInfoPanel(MinecraftClient client, MatrixStack matrices) {
        ...
        } catch (Exception e) { lines.add("§7Bioma  §8N/A"); }
        ...
        int hours = (int)((t/1000+6)%24), mins = (int)((t%1000)*60/1000);
    ...
    private static void renderHeldItemInfo(MinecraftClient client, MatrixStack matrices) {
        ...
        if (held.isDamageable()) {
            int cur = held.getMaxDamage()-held.getDamage(), max = held.getMaxDamage();
